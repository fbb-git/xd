...
void usage(std::string  const  &progname)
{
    ...
    "  --popularity <fname>      - use <fname> to store info about choices\n"
    "  --popular-separate        - separate previous choices from new\n"
    "                              expansions by a blank line\n"
    "  --popular-last            - show previously made choices after new\n"
    "                              extensions\n"
